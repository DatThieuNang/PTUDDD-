...
class MemoryDataSource {
  ...
  final List<Book> catalog = [
    Book(
      ...
      salePercent: 0, ratingAvg: 4.6, soldCount: 1540, publishedAt: DateTime(2022,10,1),
    ),
    Book(
      id:'b102',
      ...
      salePercent: 30, ratingAvg: 4.4, soldCount: 980, publishedAt: DateTime(2023,6,12),
    ...
    Book(
      ...
      salePercent: 0, ratingAvg: 4.8, soldCount: 2120, publishedAt: DateTime(2024,3,20),
    ),
    Book(
      id:'b104',
      ...
      salePercent: 15, ratingAvg: 4.5, soldCount: 1670, publishedAt: DateTime(2021,9,10),
      flashSaleEnd: DateTime.now().add(const Duration(hours: 4, minutes: 30)),
    ),
    Book(
      id:'b105',
      ...
      salePercent: 0, ratingAvg: 4.7, soldCount: 1980, publishedAt: DateTime(2020,5,2),
    ),
    Book(
      id:'b106',
      ...
      salePercent: 20, ratingAvg: 4.2, soldCount: 820, publishedAt: DateTime(2023,12,1),
      flashSaleEnd: DateTime.now().add(const Duration(hours: 8)),
    ),
    Book(
      id:'b107',
      ...
      salePercent: 0, ratingAvg: 4.9, soldCount: 2660, publishedAt: DateTime(2022,2,14),
    ),
    Book(
      id:'b108',
      ...
      salePercent: 10, ratingAvg: 4.3, soldCount: 740, publishedAt: DateTime(2024,9,1),
      flashSaleEnd: DateTime.now().add(const Duration(hours: 2, minutes: 15)),
    ),
    Book(
      id:'b109',
      ...
      salePercent: 0, ratingAvg: 4.1, soldCount: 560, publishedAt: DateTime(2019,11,11),
    ),
    Book(
      id:'b110',
      ...
      salePercent: 25, ratingAvg: 4.6, soldCount: 3050, publishedAt: DateTime(2018,7,7),
      flashSaleEnd: DateTime.now().add(const Duration(hours: 3, minutes: 5)),
    ),
  ];
