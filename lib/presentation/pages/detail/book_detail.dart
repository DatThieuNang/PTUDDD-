          ...
          return SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                // Tên + tác giả
                Text(widget.book.title, style: const TextStyle(fontSize: 20, fontWeight: FontWeight.w700)),
                const SizedBox(height: 4),
                Text(widget.book.author, style: const TextStyle(color: Colors.black54)),
                const SizedBox(height: 12),

                // === GIỚI THIỆU (ở trong trang chi tiết) ===
                if (widget.book.description.isNotEmpty) ...[
                  const Text('Giới thiệu', style: TextStyle(fontWeight: FontWeight.w700)),
